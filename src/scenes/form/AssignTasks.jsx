...
const AssignTasks = () => {
  ...
  useEffect(() => {
    const getCreatedProjects = async () => {
      try {
        const response = await axios.get('https://hr-backend-seven.vercel.app/api/project/created', {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const formData = {
      ...
      textDescription: e.target.textDescription.value, // Add textDescription to form data
    ...
    try {
      if (editingIndex !== null) {
        ...
        await axios.put(`https://hr-backend-seven.vercel.app/api/assigned-tasks/${projectId}`, formData);
        const updatedProjects = [...projects];
        updatedProjects[editingIndex] = { ...formData, _id: projectId };
        setProjects(updatedProjects);
        toast.success("Task updated successfully");
      } else {
        const response = await axios.post("https://hr-backend-seven.vercel.app/api/create-tasks", formData);
