  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (editingIndex !== null) {
        ...
        await axios.put(`https://hr-backend-gamma.vercel.app/api/assigned-tasks/${projectId}`, formData);
        const updatedProjects = [...projects];
        updatedProjects[editingIndex] = { ...formData, _id: projectId };
        setProjects(updatedProjects);
        toast.success("Task updated successfully");
      } else {
        const response = await axios.post("https://hr-backend-gamma.vercel.app/api/create-tasks", formData);
