...
const CreateInvoice = () => {
  ...
  const fetchInvoices = async () => {
    try {
      const response = await axios.get('https://hr-backend-seven.vercel.app/api/create-invoices');
  ...
  const handleFormSubmit = async (values) => {
    try {
      const response = await axios.post('https://hr-backend-seven.vercel.app/api/invoices', {
        ...values,
