...
const ProjectTaskPage = () => {
  ...
  useEffect(() => {
    const getAllUsers = async () => {
      try {
        const allUsers = await axios.get("https://update-abidibackend.vercel.app/api/users/names");
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (editingIndex !== null) {
        ...
        await axios.put(`https://update-abidibackend.vercel.app/api/assign-tasks/`, formData);
        const updatedProjects = [...projects];
        updatedProjects[editingIndex] = { ...formData, _id: projectId };
        setProjects(updatedProjects);
        toast.success("Task updated successfully");
      } else {
        const response = await axios.post("https://update-abidibackend.vercel.app/api/assign-tasks", formData);
  ...
  const saveAssignTask = async () => {
    ...
    try {
      await axios.post("https://update-abidibackend.vercel.app/api/create-tasks", formData);
      alert("Task Assigned Successfully");
      await axios.get("https://update-abidibackend.vercel.app/api/task/mail", {
        params: {
