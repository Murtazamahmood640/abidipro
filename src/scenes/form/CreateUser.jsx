...
const CreateUser = () => {
  ...
  useEffect(() => {
    const getManagers = async () => {
      try {
        const { data } = await axios.get('https://update-abidibackend.vercel.app/api/getUser');
  ...
  const handleFormSubmit = async (values) => {
    ...
    try {
      const response = await axios.post('https://update-abidibackend.vercel.app/api/users/create-user', {
        ...values,
      ...
      await axios.get('https://update-abidibackend.vercel.app/api/createUser/mail', {
        params: {
