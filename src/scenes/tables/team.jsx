...
const Team = ({ setEmployeeCount }) => {
  ...
  const handleDeleteClick = async () => {
    if (selectedUser == null) {
      ...
      try {
        const response = await axios.delete(`https://update-abidibackend.vercel.app/api/deleteUser/${selectedUser._id}`);
  ...
  const handleEditSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://update-abidibackend.vercel.app/api/updateUser/${selectedUser._id}`, {
      ...
      const updatedData = await axios.get('https://update-abidibackend.vercel.app/api/getUser');
