...
const AllDoc = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await axios.get('https://update-abidibackend.vercel.app/api/documents');
        ...
        <Box className="main-content" flexGrow={1} p={2} style={{ fontFamily: 'Poppins' }}>
          ...
          >
            <DataGrid
              ...
              onRowClick={(params) => window.open(`https://update-abidibackend.vercel.app/${params.row.path}`, '_blank')}
            />
          </Box>
        </Box>
