...
const Dashboard = () => {
  ...
  const fetchEmployeeData = async () => {
    try {
      const response = await axios.get("https://update-abidibackend.vercel.app/api/EmployeesPayroll");
  ...
  const fetchProjectCount = async () => {
    try {
      const response = await axios.get("https://update-abidibackend.vercel.app/api/project/count");
